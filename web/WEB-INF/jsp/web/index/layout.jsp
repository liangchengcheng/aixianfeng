        ...
        <div class="index-article-list">
            <div class="article-item" ng-repeat="article in articleList">
                <div class="article-header">
                    <a href="${staticDomain}/#/category/{{ article.categorySlug }}" class="article-category">[{{
    ...
    <div class="article-content">
        <div class="content-head">
            ...
            <div class="content-head-detail">
                ...
                <span class="c_name"><a href="${staticDomain}/#/category/{{ f_article.categorySlug }}"><i
                        class="fa fa-align-justify" aria-hidden="true"></i> {{ f_article.categoryName }}</a></span>
